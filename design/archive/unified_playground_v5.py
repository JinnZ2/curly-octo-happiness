...
# =========================================================================
# 3. BUMPY WORLD & WORLD MODEL (unchanged)
# =========================================================================
class BumpyWorld:
    def __init__(self):
        self.x = 0.0
...
# =========================================================================
# 8. HARDWARE BRIDGE ENCODER (with thermal-runaway quarantine)
# =========================================================================
import math
...
def _gray_bits(value, bands, n_bits=None):
    idx = 0
...
class HardwareBridgeEncoder:
    ...
    def to_binary(self):
        ...
        bits.append(_gray_bits(temp, _TEMP_BANDS))
...
# =========================================================================
# 9. SIMULATED HARDWARE CIRCUIT (for Ari to monitor)
# =========================================================================
class VirtualComponent:
    ...
    def apply_stress(self, severity=0.1):
        ...
        # Update measurements to reflect degradation
        ...
        # Determine failure mode based on health and type
...
# =========================================================================
# 10. UNIFIED AGENT (with hardware monitoring)
# =========================================================================
class UnifiedAgent:
